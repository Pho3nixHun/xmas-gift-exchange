    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-sm border-b border-white/10">
      <div className="flex justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center space-x-3">
          {showUserMenu && onNavigate && (currentStep === 'wishes' || currentStep === 'all-wishes') && (
            <>
              <motion.button
              ...
              >
                <Gift size={16} />
                <span className="hidden sm:inline">{t('navigation.myWishes')}</span>
              </motion.button>
              ...
              >
                <Users size={16} />
                <span className="hidden sm:inline">{t('navigation.allWishes')}</span>
              </motion.button>
            </>
          )}
        </div>
